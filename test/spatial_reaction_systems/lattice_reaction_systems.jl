...
CuH_Amination_srs1 = [CuH_Amination_diff_1]
CuH_Amination_srs2 = [CuH_Amination_diff_1, CuH_Amination_diff_2, CuH_Amination_diff_3, CuH_Amination_diff_4, CuH_Amination_diff_5]
...
sigmaB_p = [:kBw => 3600, :kDw => 18, :kD => 18, :kB1 => 3600, :kB2 => 3600, :kB3 => 3600, :kB4 => 1800, :kB5 => 3600, 
...
sigmaB_srs1 = [sigmaB_dif_σB]
sigmaB_srs1 = [sigmaB_dif_σB, sigmaB_dif_w, sigmaB_dif_v]
...
let 
    ...
    pE = [:dX => 0.1, :dY => 0.2]
    oprob = ODEProblem(lrs, u0, (0.0,10.0), (pV,pE); jac=false)
    runtime = median((@benchmark solve(oprob, Tsit5())).times)/1000000000
    println("Small grid, small, non-stiff, system. Runtime: $(runtime), previous standard:$(1)")
    @test runtime < 2*1
end
...
let 
    ...
    oprob = ODEProblem(lrs, u0, (0.0,10.0), (pV,pE); jac=false)
    runtime = median((@benchmark solve(oprob, Tsit5())).times)/1000000000
    println("Large grid, small, non-stiff, system. Runtime: $(runtime), previous standard:$(1)")
    @test runtime < 2*1
end
...
let 
    ...
    runtime = median((@benchmark solve(oprob, QNDF())).times)/1000000000
    println("Small grid, small, stiff, system. Runtime: $(runtime), previous standard:$(1)")
    @test runtime < 2*1
end
...
let 
    ...
    oprob = ODEProblem(lrs, u0, (0.0,100.0), (pV,pE))
    runtime = median((@benchmark solve(oprob, QNDF())).times)/1000000000
    println("Large grid, small, stiff, system. Runtime: $(runtime), previous standard:$(1)")
    @test runtime < 2*1
end
...
let 
    ...
    oprob = ODEProblem(lrs, u0, (0.0,10.0), (pV,pE); jac=false)
    runtime = median((@benchmark solve(oprob, Tsit5())).times)/1000000000
    println("Small grid, mid-sized, non-stiff, system. Runtime: $(runtime), previous standard:$(1)")
    @test runtime < 2*1
end
