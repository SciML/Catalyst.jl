...
sol_det1 = OrdinaryDiffEq.solve(prob_det1,Tsit5())
sol_det2 = OrdinaryDiffEq.solve(prob_det2,Tsit5())
...
sol_jump1 = DiffEqJump.solve(jump_prob1,FunctionMap(),maxiters = 1e6)
sol_jump2 = DiffEqJump.solve(jump_prob2,FunctionMap(),maxiters = 1e6)
