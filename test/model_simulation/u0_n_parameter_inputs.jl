...
for factor = [1e-2, 1e-1, 1e0, 1e1, 1e2, 1e3]
    ...
    p_2 = [p1=>p_1[1], p2=>p_1[2], p3=>p_1[3], k1=>p_1[4], k2=>p_1[5], v1=>p_1[6],
            K1=>p_1[7], k3=>p_1[8], d1=>p_1[9], d2=>p_1[10], d3=>p_1[11], d4=>p_1[12],
            d5=>p_1[13]]
    p_3 = [k2=>p_1[5], k3=>p_1[8], v1=>p_1[6], d5=>p_1[13], p2=>p_1[2], p1=>p_1[1],
           d2=>p_1[10], K1=>p_1[7], d1=>p_1[9], d4=>p_1[12], d3=>p_1[11], p3=>p_1[3],
           k1=>p_1[4]]
    sols = []
