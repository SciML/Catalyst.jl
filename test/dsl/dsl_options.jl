...
# Compares two networks with different parameter/species names.
let
    # Declares network.
...
let
    ...
    push!(networks_1, reaction_networks_standard[10])
    push!(networks_2, no_parameters_10)
...
# Tests that reaction systems created manually and through macro are identical.
let
