...
test_jac = ODEFunction(convert(ODESystem, jacobian_network_1), jac = true).jac([
                                                                                   1.0,
                                                                                   1.0,
                                                                                   1.0,
                                                                               ], [], 0.0)
...
for factor in [1e-2, 1e-1, 1e0, 1e1, 1e2], repeat in 1:10
    u = factor * rand(rng, 3)
    p = factor * rand(rng, 3)
    local test_jac = ODEFunction(convert(ODESystem, jacobian_network_2), jac = true).jac(u,
                                                                                         p,
                                                                                         0.0)
...
for factor in [1e-2, 1e-1, 1e0, 1e1, 1e2], repeat in 1:10
    ...
    local test_jac = ODEFunction(convert(ODESystem, jacobian_network_3), jac = true).jac(u,
                                                                                         p,
                                                                                         0.0)
