...
@add_reactions step_by_step_network_1 begin (k5, k6), X3 ⟷ X4 end k5 k6
@add_reactions step_by_step_network_1 begin d, X4 → ∅ end d
...
@add_reactions step_by_step_network_5 begin k5, X3 → X1 end k5
@add_reactions step_by_step_network_5 begin k6, X1 → X3 end k6
