...
For a more extensive documentation of non-integer stoichiometric coefficients, pelase read the [Parametric Stoichiometry](@ref parametric_stoichiometry) section.
