...
It is important to note for [`@reaction_network`](@ref) that any variable not declared
to be a parameter after `end` will be treated as a chemical species of the system. i.e. in
```julia
