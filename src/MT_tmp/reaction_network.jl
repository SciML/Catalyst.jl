...
"""
macro MT_reaction_network(name, ex::Expr, p...)
...
macro MT_reaction_network(name, scale_noise, ex::Expr, p...)
...
macro MT_reaction_network(ex::Expr, p...)
