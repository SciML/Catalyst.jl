...
function coordinate(name, ex::Expr, p, scale_noise)
    ...
    test_f_expr = quote
        function funky(reaction_network)
    ...
    push!(exprs,Expr(:escape, quote
        function make_hc_template_another(reaction_network::DiffEqBase.AbstractReactionNetwork)
