...
make_mmr_exp(expr::Expr) = :($(expr.args[3]) * $(expr.args[4]) /
                             ($(expr.args[4]) + $(expr.args[2])))
make_hill_exp(expr::Expr) = :($(expr.args[3]) * ($(expr.args[2])^$(expr.args[5])) /
                              ($(expr.args[4])^$(expr.args[5]) + $(expr.args[2])^$(expr.args[5])))
make_hillr_exp(expr::Expr) = :($(expr.args[3]) * ($(expr.args[4])^$(expr.args[5])) /
                               ($(expr.args[4])^$(expr.args[5]) + $(expr.args[2])^$(expr.args[5])))
make_hillar_exp(expr::Expr) = :($(expr.args[4]) * ($(expr.args[2])^$(expr.args[6])) /
